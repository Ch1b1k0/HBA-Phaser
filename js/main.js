...
var hasKey = false;
var level = 0;
alert("BAT: HAHAHAHAHAHAHAHAHAHA YOU FOLOLISH TREE! I DON'T THINK YOU'LL BE ABLE TO SURVIVE MY AMAZING PUZZLE!!!!!!!! WHAT!?!?!?! YOU THINK YOU CAN?!?!?!?! I'D LIKE TO SEE YOU TRY!!!!!!!")
alert("TREE: please help me, my little smaplings are waiting for me.")
alert("MISSION: get tree saftly back home, collect keys to pass through doors, and DON'T DIE!!!")
alert("little voice: Can you...Can you find all the sercrets. *whispers* their isn't that many...Mr.Bat took most of the fun out of the game after a certain incidents....He didn't always act like this...Help everyone. BUT you didn't hear it from me!!!!!!!!!!!!!!!!!!!!!!!")
console.log("The stupid tree thinks he can survive. NYAHEH HEH HEH HEH. I  can't wait till he relizes the trap I set out for him in level 3. OH? Do you want to know about me? well when I was a young lad no one liked me and I didn't like them...I always wanted a friend. And, one day I finally got one. She was a pretty little mouse, I wqould talk, make her laugh, and sing little songs to put her to sleep....She was very beatiful. She liked puizzels, like me. I set up a mini-puzzel game for her and me. we would always play and make jokes. The frist time I showed her our little puzzel, she got irrated! She nearly quit! But, she put on a big smile and kept on trying. I loved her so much. When she got to the thrid level she got really confused but I expailn that it was differnt than the second, just a one block difference. We would always be together. I planned to propse but....Humans came. They didn't like roddens expect little hamsters...They set up traps and my love fell into one, and died. I wish I was there to help her.....So I started to hate humans, and I relized that we all need air to survive. So, I'm planning to DESTORY ALL TREES THEN ALL THE STUPID HUMANS WILL DIE AND NONE OF THEM WILL LIVE. But niether will I, but you know what I don't really care! At least....at least....At least I'll be with my beloved little mouse....That's all story time is over!!!!")
function init(){
...
function preload(){
    ...
    game.load.image('grass:8x1', 'images/404.gif');
